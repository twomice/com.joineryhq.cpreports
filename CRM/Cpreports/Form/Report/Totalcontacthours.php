...
class CRM_Cpreports_Form_Report_Totalcontacthours extends CRM_Report_Form {
      ...
      'civicrm_contact_target' => array(
        ...
        'fields' => array(
          'contact_target' => array(
            'name' => 'sort_name',
            'title' => E::ts('Target (Serving Team) Name'),
        ...
        'filters' => array(
          ...
          'nick_name_like' => array(
            'title' => E::ts('Serving Team Nickname'),
  ...
  public function alterDisplay(&$rows) {
    ...
    foreach ($rows as $rowNum => $row) {
      ...
      if (array_key_exists('civicrm_contact_assignedteam_contact_id_a', $row)) {
        if ($value = $row['civicrm_contact_assignedteam_contact_id_a']) {
          $displayLinks = [];
          ...
          $rows[$rowNum]['civicrm_contact_assignedteam_contact_id_a'] = implode('<br />', $displayLinks);
          $entryFound = TRUE;
        }
      }
