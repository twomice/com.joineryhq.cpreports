 ...
 */
class CRM_Cpreports_Upgrader_Base {

  /**
   * @var CRM_Cpreports_Upgrader_Base
   */
  ...
  public static function instance() {
    if (!self::$instance) {
      self::$instance = new CRM_Cpreports_Upgrader(
        'com.joineryhq.cpreports',
        E::path()
      );
    }
   ...
   *
   * ```
   * CRM_Cpreports_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * ```
   */
  ...
  /**
   * CRM_Cpreports_Upgrader_Base constructor.
   *
   * @param $extensionName
   * @param $extensionDir
   */
